        ...
        if epoch % valid_interval == 0:
            with torch.no_grad():
                ...
                if saver == {} or valid_metric["micro_f1"] > saver["valid"]["micro_f1"]:
                    ...
                    with open("./data/results_{}.jsonl".format(config.get("data", "formatter_name")[:-9]), "w",
                              encoding="utf-8") as f:
                    ...
                    with open('./performance/{}_prf_report-valid.txt'.format(config.get('model', 'model_name')), 'w',
                              encoding='utf-8') as f:
